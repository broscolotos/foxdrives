...
class GuiButtonWrap extends GuiButton {
    enum Type {
        SELECTIONBOX,
        ARROWUP,
        ARROWDOWN,
    ...
    public GuiButtonWrap(int buttonID, int x, int y, int xSize, int ySize, Type type) {
    ...
    public void drawButton(Minecraft mc, int par2, int par3) {
        if (this.visible && showButton) {
            ...
            GL11.glPushMatrix();
            mc.renderEngine.bindTexture(new ResourceLocation(FoxDrives.MODID + ":textures/gui/gui_paintbrush_menu_buttons.png"));
